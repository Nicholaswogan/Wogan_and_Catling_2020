...
% This script is identical to gibbs.m except that the Berman-Brown convention 
% for Gibbs energies of formation is is retained
...
function G=gibbs(species,T)
    ...
    temp=G; %% Retain Berman-Brown convention 
    %%%%
    ...
    G=temp;   % Retain Berman-Brown convention        % species have in them. (So, since CH4 has 4 H's, subtract the gibbs free energy of
